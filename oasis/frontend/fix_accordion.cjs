...
if (start > -1 && end > start) {
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex flex-col min-w-0 flex-1">
                                                                        ...
                                                                        <span className={\`text-[11px] font-black uppercase tracking-wide mt-0.5 leading-tight transition-colors \${isExpanded ? 'text-white' : 'text-zinc-300 group-hover/step:text-white'}\`}>{node.label}</span>
                                                                    </div>
    ...
    console.log('Fixed block securely!');
} else {
