                        ...
                        <div className="min-h-[40vh] font-sans">
                            {step === 0 && (
                                <div className="space-y-4 animate-in fade-in duration-300">
                                    ...
                                    <h3 className="text-[9px] sm:text-xs md:text-sm font-semibold leading-relaxed text-white/90">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full min-h-[40vh] bg-transparent resize-none border-none text-[10px] sm:text-xs md:text-base text-zinc-200 font-sans leading-relaxed focus:outline-none placeholder:text-zinc-700 p-0 pt-2 pb-32 overflow-hidden"
                                    />
                                </div>
                            )}
