        ...
        <div className="prose prose-invert max-w-none text-[14px] md:text-[16px] font-sans text-white/90 leading-relaxed selection:bg-white/20">
            {blocks.map((block, i) => {
                ...
                if (trimmed.startsWith('[question]')) {
                    ...
                    return (
                        <div key={i} className="my-8 p-6 md:p-8 bg-zinc-900/50 backdrop-blur-sm rounded-2xl border border-zinc-800 shadow-md animate-in slide-in-from-right duration-700">
...
export const WordByWordRenderer = ({ content, speed = 5, wordsPerTick = 3, onComplete }) => {
