...
const newStyle = `style={{
                        ...(!isSplitViewEnabled && isChatOpen && window.innerWidth >= 768 ? {
                            left: 'calc(10vw + 28vw + 20px)',
                            right: '10vw',
                            width: 'auto'
                        } : {})
...
console.log('Composer UI updated for split view');
