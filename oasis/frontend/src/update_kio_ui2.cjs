...
const regex = /<div className="bg-black\/40 p-5 rounded-2xl border border-cyan-500\/10 space-y-2">\s*<h3 className="text-\[10px\] font-black uppercase tracking-widest text-cyan-500">\s*Memoria y Contexto Base\s*<\/h3>\s*<AutoResizeTextarea[\s\S]*?\/>\s*<\/div>/;
